...
export class EmailService {
  ...
  async sendVerificationEmail(email: string, otp: string, firstName?: string): Promise<boolean> {
    try {
      ...
      const mailOptions = {
        from: '"VeeFore Support" <noreply@veefore.com>',
        to: email,
  ...
  async sendWelcomeEmail(email: string, firstName?: string): Promise<boolean> {
    try {
      const mailOptions = {
        from: '"VeeFore Team" <welcome@veefore.com>',
        to: email,
        ...
        <div style="max-width: 600px; margin: 0 auto; background: #ffffff;">
            ...
            <div style="padding: 40px 30px; background: #ffffff;">
                ...
                <div style="margin: 30px 0;">
                    ...
                    <div style="margin: 15px 0; padding: 15px; border-left: 4px solid #3b82f6; background: #f8fafc;">
                    ...
                    <div style="margin: 15px 0; padding: 15px; border-left: 4px solid #f59e0b; background: #fffbeb;">
                        <strong style="color: #d97706; font-size: 16px;">🤖 Automation Tools</strong>
                        <p style="color: #4b5563; margin: 5px 0 0 0; font-size: 14px;">Schedule posts and automate interactions across platforms</p>
                    </div>
                </div>

                <div style="text-align: center; margin: 30px 0;">
                    <a href="https://app.veefore.com/dashboard" style="display: inline-block; background: linear-gradient(135deg, #1e40af 0%, #3b82f6 100%); color: #ffffff; text-decoration: none; padding: 15px 30px; border-radius: 8px; font-weight: 600; font-size: 16px;">
                        Get Started Now
                    </a>
                </div>
