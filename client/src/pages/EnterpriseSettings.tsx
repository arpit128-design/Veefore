...
const EnterpriseSettings = () => {
  ...
  const [preferences, setPreferences] = useState({
    ...
    ai: {
      ...
      failoverModels: ['gpt-3.5-turbo'],
      rateLimitHandling: 'queue',
      errorRetries: 3,
    ...
    billing: {
      ...
      reportRecipients: [],
      costOptimization: true,
      unusedResourceAlerts: true,
      renewalReminders: true,
      reminderDays: [30, 7, 1],
      failedPaymentRetries: 3,
      downgradeProtection: true,
      gracePeriod: 7,
      dataRetentionAfterCancel: 30,
      exportDataBeforeCancel: true,
      cancellationSurvey: true,
      winBackOffers: false,
      loyaltyDiscounts: true,
      volumeDiscounts: true,
      enterpriseNegotiation: false,
